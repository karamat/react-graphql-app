    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { autoComplete: 'off', autoFocus: true, type: 'text', name: 'name', onChange: this._changeName.bind(this), value: this.props.user.name })
        ),
        _react2.default.createElement(
          'div',
          null,
          ...
          _react2.default.createElement('input', { autoComplete: 'off', type: 'number', name: 'age[min]', onChange: this._changeMinAge.bind(this), value: this.props.user.age.min }),
          _react2.default.createElement('input', { autoComplete: 'off', type: 'number', name: 'age[max]', onChange: this._changeMaxAge.bind(this), value: this.props.user.age.max })
        ),
        _react2.default.createElement(
          'div',
          null,
          ...
          _react2.default.createElement(
            'select',
            { name: 'profession', onChange: this._changeProfession, value: this.props.user.profession },
            this.props.professions.map(function (p) {
              return _react2.default.createElement(
                'option',
                { key: "profession-" + p.value, value: p.name },
                p.name
              );
            })
          )
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'select',
            { name: 'region', onChange: this._changeRegion, value: this.props.user.region },
            this.props.regions.map(function (p) {
              return _react2.default.createElement(
                'option',
                { key: "region-" + p.value, value: p.name },
                p.name
              );
            })
          )
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'select',
            { name: 'religion', onChange: this._changeReligion, value: this.props.user.religion },
            this.props.religions.map(function (p) {
              return _react2.default.createElement(
                'option',
                { key: "religion-" + p.value, value: p.name },
                p.name
              );
            })
          )
